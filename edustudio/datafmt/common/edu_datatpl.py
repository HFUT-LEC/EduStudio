...
class EduDataTPL(GeneralDataTPL):
    ...
    def common_str2df(self):
        return {
            ...
            "df_test": self.df_test, "df_stu": self.df_stu, "df_exer": self.df_exer, "dt_info": self.datafmt_cfg['dt_info']
        }
    ...
    def load_data_from_side_information(cls, cfg):
        ...
        stu_exclude_feats = cfg.datafmt_cfg['stu_exclude_feat_names']
        exer_exclude_feats = cfg.datafmt_cfg['exer_exclude_feat_names']
